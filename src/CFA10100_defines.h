#ifndef __Screen_Defines_H__
#define __Screen_Defines_H__
//============================================================================
//
...
// We arent using SD card for this right now
...
#define CLR_EVE_PD_NOT gpio_set_level(EVE_PD_NOT, 0) // Set Power Down Low
#define SET_EVE_PD_NOT gpio_set_level(EVE_PD_NOT, 1) // Set Power Down High
#define CLR_EVE_CS_NOT gpio_set_level(EVE_CS_NOT, 0) // Set Chip Select Low
#define SET_EVE_CS_NOT gpio_set_level(EVE_CS_NOT, 1) // Set Chip Select High
